        ...
        <div>
            <Navbar  expand="lg" className="NavBar">
                ...
                <Nav className="ml-auto p-2">
                    ...
                    <Nav.Link className="NavIcon" href="https://www.instagram.com/publicity_eco/">
                    ...
                    <Nav.Link className="NavIcon" href="https://api.whatsapp.com/send?phone=5491155776472&text=Hello! I will answer you as soon as possible.">
                    <button className="Icon" > 
