    ...
    return(
        ...
        <div >
            ...
            <div>
                ...
                <Card className="Card">
                    <Card.Img variant="top" src="../assets/Carrusel4.png" />
                    <Card.Body className="CardBody">

                        <Card.Title className="CardTittle"> <b> {locales.name} </b> </Card.Title>

                        <Button className="ButtonInstagram" href={locales.instagram} target="_blank" variant="success">
                        ...
                        <Button className="ButtonWp" href={locales.wp} target="_blank"  variant="success">
