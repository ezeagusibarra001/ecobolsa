        ...
        <div className="Footerfondo" id="contacto">
            ...
            <div className="Contenedor">
                ...
                <div className="Texto1">
                    <p className="Leyenda1">Somos una empresa de publicidad innivadora que
                        que utiliza medio ecologicos de difusion.
                    </p>
                </div>
                ...
                <div className="Gmail">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" className="Iconogmail" width="100" height="100" fill="white"  viewBox="0 0 16 16">
                ...
                <div className="Pibicreditos">PubliCity 2021 | Sitio Web por Pibi Agencia</div>
            </div>
        </div>
    )
}
